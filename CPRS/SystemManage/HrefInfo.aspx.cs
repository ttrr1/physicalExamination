...
{
    public partial class HrefInfo : System.Web.UI.Page
    {
        Hrefbll bll = new Hrefbll();
        ...
        private void DelData()
        {
            ...
            {
                int delNum = DataHandler.DelData("Href", selectID, "HrefID");
                if (delNum > 0)
                {
        ...
        private void QueryOneData()
        {
            ...
            DataSet ds = bll.GetList(1, "HrefID=" + userid, "HrefID ASC");
        ...
        private void QueryData()
        {
            ...
            DataSet dsUser = DataHandler.GetList("Href", "*", "HrefID", size, page, false, false, strWhere);
