...
{
    public partial class RevertList : System.Web.UI.Page
    {
        Revertbll bll = new Revertbll();
        ...
        private void DelData()
        {
            ...
            {
                int delNum = DataHandler.DelData("Revert", selectID, "RevertID");
                if (delNum > 0)
                {
        ...
        private void QueryOneData()
        {
            ...
            DataSet ds = bll.GetList(1, "RevertID=" + userid, "RevertID ASC");
        ...
        private void QueryData()
        {
            ...
            DataSet dsUser = DataHandler.GetList("Revert", "*", "RevertID", size, page, false, false, strWhere);
