<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true"
    CodeBehind="RevertList.aspx.cs" Inherits="BLOGBack.SystemManage.RevertList" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <table cellpadding="0" cellspacing="0" style="width: 100%">
            <tr>
                <td style="padding-left: 2px">
                    ...
                    <a href="#" onclick="DelData(0);return false;" id="a_del" class="easyui-linkbutton"
    ...
    <%--列表 end--%>
    <%--添加 修改 start--%>
    <div id="edit" class="easyui-dialog" title="编辑回复" style="width: 500px; height: 350px;"
        modal="true" closed="true" buttons="#edit-buttons">
        <form id="form_edit" name="form_edit" method="post" url="RevertList.aspx">
        ...
        <table class="table_edit">
            <tr>
                ...
                <td class="tdar">
                    <input id="ipt_Content" name="ipt_Content" type="text" class="easyui-validatebox"
                        required="true" style="overflow: auto;" />
                </td>
            </tr>
        </table>
        </form>
    ...
    <script type="text/javascript">
        ...
        function InitGird() {
            $('#tab_list').datagrid({
                ...
                sortName: 'JSON_RevertID', //排序字段
                idField: 'JSON_RevertID', //标识字段,主键
                iconCls: '', //标题左边的图标
                width: '80%', //宽度
                ...
                columns: [[
                    { title: '标题', field: 'JSON_Subject', width: 100 },
                    { title: '内容', field: 'JSON_Content', width: 500 },
                    { title: '发布人', field: 'JSON_UserName', width: 100 },
                    { title: '发布时间', field: 'JSON_Time', width: 150 },
                    { title: '访问人', field: 'JSON_VisitorName', width: 100 },
                    { title: '操作', field: 'JSON_RevertID', width: 80, formatter: function (value, rec) {
