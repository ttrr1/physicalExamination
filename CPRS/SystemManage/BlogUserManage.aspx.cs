...
{
    public partial class BlogUserManage : System.Web.UI.Page
    {
        ...
        private void DelData()
        {
            ...
            {
                int delNum = DataHandler.DelData("BlogUser", selectID, "BlogID");
                if (delNum > 0)
                {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        private BlogUser GetData(int id)
        {
        ...
        private void QueryOneData()
        {
            ...
            DataSet ds = bll.GetList(1, "BlogID=" + userid, "BlogID ASC");
        ...
        private void QueryData()
        {
            ...
            DataSet dsUser = DataHandler.GetList("BlogUser", "*", "BlogID", size, page, false, false, strWhere);
